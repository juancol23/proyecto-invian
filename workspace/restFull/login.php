...
<head>
    ...
    <!-- <script src="https://bs-static.cdn.telerik.com/1.9.4/everlive.all.min.js"></script> -->
    ...
    if($("#email").val() && $("#password").val()){
      ...
      $.ajax({
          ...
          success: function (data) {
            ...
            location.href = 'http://localhost/adminadbeacons/dashboard.html+0?x='+ token.replace(/"/g,"");
